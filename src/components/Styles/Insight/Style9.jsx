...
const Style9 = ({ data }) => {
  ...
  const { latestInsightData, twoInsightData } = useSelector(
    (state) => state.blog,
  );
      ...
      <section class="dg-news pt-120 pb-60">
        <div class="container">
          ...
          <div class="row justify-content-center">
            {Array.isArray(twoInsightData) &&
              twoInsightData?.map((item, idx) => (
                <Link
                      ...
                      latestInsightData?.map((item, idx) => (
                        <li class="mb-3">
                          <Link to={`/insights/${item?.insight_slug}`}>
                            ...
                            <h5 class="h6">{item?.insight_title}</h5>
                          </Link>
                        </li>
                      ))}
                  </ul>
